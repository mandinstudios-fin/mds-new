...
const AboutUs = () => {
    ...
    return (
        <div
            className="flex h-auto overflow-x-hidden bg-fixed bg-center bg-cover py-010 ite lg:w-screen lg:h-screen lg:py-0"
            style={{ backgroundImage: "url('/images/BG.jpg')" }}
        >
            <section className="max-w-[1536px] mx-auto flex flex-col py-7">
                ...
                <div className='flex items-center justify-center gap-16'>
                    <div className=''>
                        <h2 className='font-bold text-white text-[7rem] leading-[1] italic mt-20 ml-4'>
                            <span>Create <br /></span>
                            <span className='flex items-center gap-[2rem]'><button className='text-xl font-semibold bg-[#74aa9b] p-4 py-3 mt-4 rounded-full text-black'>Start now</button><span>and sell</span></span>
                        </h2>
                    </div>
                    <div className='flex justify-start -ml-4'>
                        <img src='/images/abt.png' width={510} className='' />
                    </div>
                </div>

                <div className='grid w-full grid-cols-3 mt-32'>
                    <div className='h-[25rem] w-full p-4 flex border border-[#74aa9b] rounded-[1rem] relative bg-[#1a3c33]'>
                        <div className='my-auto ml-20 space-y-2 font-light text-white'>
                    ...
                    <div className='h-[25rem] w-full p-4 px-8 bg-[#74aa9b] rounded-[1rem] border border-[#74aa9b] relative'>
                        <p className='mt-14 text-[1.3rem] font-light'>Mandin Studios is a powerhouse of innovation, blending technology, security, and design to build cutting-edge digital solutions. With expertise in fintech, cybersecurity, user experience, and blockchain, we craft scalable and secure platforms that drive business success.</p>
                    ...
                    <div className='h-[25rem] w-full p-4 text-white flex justify-center border border-[#74aa9b] rounded-[1rem] relative bg-[#1a3c33]'>
                        <div className='my-auto text-center'>
                            <p className='font-extralight text-[1.4rem] text-[#d6d2b3]'>We make digital (and simple)</p>
